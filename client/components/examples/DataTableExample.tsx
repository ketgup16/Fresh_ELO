  ...
  return (
    <div style={styles.paginationBar}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
        ...
        <span style={{ fontSize: '13px', color: 'var(--ld-semantic-color-text, #2E2F32)', padding: '0 4px' }}>
          Page
        </span>
...
const INLINE_STYLES = {
  toolbar: {
    ...
    gap: '12px',
    padding: '12px 16px',
    borderBottom: '1px solid var(--ld-semantic-color-border-subtle, #E2E2E3)',
  ...
  paginationBar: {
    ...
    padding: '12px 16px',
    borderTop: '1px solid var(--ld-semantic-color-border-subtle, #E2E2E3)',
    background: 'var(--ld-semantic-color-surface-primary, #fff)',
  },
  paginationInfo: {
    fontSize: '13px',
