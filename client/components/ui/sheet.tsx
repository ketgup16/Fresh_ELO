  ...
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      style={{
        ...
        padding: 'var(--ld-semantic-spacing-300, 1.5rem)',
    ...
    >
      ...
      <SheetPrimitive.Close
        className="absolute right-4 top-4 rounded-sm transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none"
        style={{
          opacity: 0.7,
          color: 'var(--ld-semantic-color-text, #2E2F32)',
        }}
      >
        <X style={{ width: 'var(--ld-semantic-scale-icon-small, 1rem)', height: 'var(--ld-semantic-scale-icon-small, 1rem)' }} />
