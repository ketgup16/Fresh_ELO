  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1 text-xs hover:bg-[var(--ld-semantic-color-fill-surface-secondary)] px-2 py-1 rounded transition-colors"
      >
        <span style={{ color: 'var(--ld-semantic-color-text-primary)' }}>{getDisplayName(currentSolution)}</span>
        {isOpen ? (
            ...
            <div className="p-4">
              ...
              <div className="grid grid-cols-2 gap-2 mb-4">
                ...
                <button
                  ...
                  className="flex flex-col items-center justify-center p-3 rounded transition-colors min-h-[100px]" style={{ border: '1px solid var(--ld-semantic-color-border-subtle)' }} onMouseEnter={e => (e.currentTarget.style.borderColor = 'var(--ld-semantic-color-action-border-primary)')} onMouseLeave={e => (e.currentTarget.style.borderColor = 'var(--ld-semantic-color-border-subtle)')}
                >
                  <div className="w-12 h-12 mb-2 relative">
                    <div className="w-8 h-8 rounded absolute left-1 top-0" style={{ backgroundColor: '#4DBDF5' }} />
                    <div className="w-8 h-8 rounded absolute left-0 top-1 flex items-center justify-center" style={{ backgroundColor: 'var(--ld-semantic-color-text-brand, #001E60)' }}>
                      <Search className="w-5 h-5 text-white" />
                    </div>
                  </div>
                  <span className="text-xs text-center" style={{ color: 'var(--ld-semantic-color-text-primary)' }}>Sponsored Search</span>
                </button>

                {/* Display Advertising */}
                <button
                  onClick={() => handleSolutionClick('Display Advertising', '/')}
                  className="flex flex-col items-center justify-center p-3 rounded transition-colors min-h-[100px]"
                  style={{
                    border: `1px solid ${currentSolution === 'Display Advertising' ? 'var(--ld-semantic-color-action-border-primary)' : 'var(--ld-semantic-color-border-subtle)'}`,
                    backgroundColor: currentSolution === 'Display Advertising' ? 'var(--ld-semantic-color-action-fill-primary-subtle, #E9F1FE)' : undefined
                  }}
                >
                  ...
                  <span className="text-xs text-center" style={{ color: 'var(--ld-semantic-color-text-primary)' }}>Display Advertising</span>
                </button>
                ...
                >
                  ...
                  <span className="text-xs text-center" style={{ color: 'var(--ld-semantic-color-text-primary)' }}>Shop Builder</span>
                </button>
                ...
                >
                  ...
                  <span className="text-xs text-center" style={{ color: 'var(--ld-semantic-color-text-primary)' }}>Store Ads</span>
                </button>

                {/* Unified Reports */}
                <button
                  onClick={() => handleSolutionClick('Unified Reports')}
                  className="flex flex-col items-center justify-center p-3 rounded transition-colors min-h-[100px] col-span-2" style={{ border: '1px solid var(--ld-semantic-color-border-subtle)' }} onMouseEnter={e => (e.currentTarget.style.borderColor = 'var(--ld-semantic-color-action-border-primary)')} onMouseLeave={e => (e.currentTarget.style.borderColor = 'var(--ld-semantic-color-border-subtle)')}
                >
                  <div className="w-12 h-12 mb-2">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect x="7" y="7" width="34" height="34" rx="3" fill="#001E60"/>
                  ...
                  <span className="text-xs text-center" style={{ color: 'var(--ld-semantic-color-text-primary)' }}>Unified Reports</span>
                </button>
              </div>

              <h3 className="text-sm font-extrabold mb-2" style={{ color: 'var(--ld-semantic-color-text-primary)' }}>Tools and help</h3>
              <div className="flex flex-col gap-2">
                <button
                  onClick={() => setIsOpen(false)}
                  className="flex items-center gap-2 p-2 rounded transition-colors" style={{ border: '1px solid var(--ld-semantic-color-border-subtle)' }} onMouseEnter={e => (e.currentTarget.style.borderColor = 'var(--ld-semantic-color-action-border-primary)')} onMouseLeave={e => (e.currentTarget.style.borderColor = 'var(--ld-semantic-color-border-subtle)')}
                >
                  <div className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#C3E7EF' }}>
                  ...
                  <span className="text-xs" style={{ color: 'var(--ld-semantic-color-text-primary)' }}>Billing Manager</span>
                </button>
                ...
                >
                  ...
                  <span className="text-xs" style={{ color: 'var(--ld-semantic-color-text-primary)' }}>Associate tools</span>
                </button>
                ...
                >
                  ...
                  <span className="text-xs" style={{ color: 'var(--ld-semantic-color-text-primary)' }}>Component Library</span>
                </button>
              </div>
            </div>
          </div>
