...
import styles from './AXButtonGroup.module.css';
 ...
 */
export type AXButtonGroupLayout = 'inline' | 'stacked';
 ...
 */
export type AXButtonGroupPattern =
  | 'primary-secondary'
  | 'primary-tertiary'
  | 'secondary-tertiary'
  | 'tertiary-tertiary'
...
export interface AXButtonGroupProps {
  /** Layout direction. @default 'inline' */
  layout?: AXButtonGroupLayout;

  /** Button pattern / combination. @default 'primary-secondary' */
  pattern?: AXButtonGroupPattern;
...
function PreferredPrimary({
  ...
  buttonProps?: AXButtonGroupProps['preferredButtonProps'];
}) {
  return (
    <Button
      variant="primary"
...
function AlternateSecondary({
  ...
  fullWidth?: boolean;
  onClick?: React.MouseEventHandler<HTMLButtonElement>;
  buttonProps?: AXButtonGroupProps['alternateButtonProps'];
}) {
  return (
    <Button
      variant="secondary"
...
function TertiaryLink({
  ...
  onClick?: React.MouseEventHandler<HTMLButtonElement>;
  buttonProps?:
    | AXButtonGroupProps['alternateButtonProps']
    | AXButtonGroupProps['thirdButtonProps'];
}) {
  return (
...
/**
 * AXButtonGroup — AX (Walmart Component Platform) button group patterns.
 *
 * Implements all standard AX button group combinations from the design system:
 *
 ...
 * />
 */
export const AXButtonGroup = React.forwardRef<
  HTMLDivElement,
  AXButtonGroupProps
>(
  (
...
AXButtonGroup.displayName = 'AXButtonGroup';
