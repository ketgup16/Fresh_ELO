...
const BoxIcon = ({ isActive }: { isActive: boolean }) => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path fillRule="evenodd" clipRule="evenodd" d="M8 1L1 4V12L8 15L15 12V4L8 1ZM8 2.118L13.764 4.5L8 6.882L2.236 4.5L8 2.118ZM2 5.618L7.5 7.882V13.382L2 11.118V5.618ZM8.5 13.382V7.882L14 5.618V11.118L8.5 13.382Z" fill={isActive ? '#0053E2' : '#2E2F32'}/>
  </svg>
);
