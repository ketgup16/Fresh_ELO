...
// ── Main AXSignatureCapture export ───────────────────────────────────────

export type AXSignatureCaptureVariant = 'trigger' | 'terms' | 'base' | 'reauth';

export interface AXSignatureCaptureProps {
  variant: AXSignatureCaptureVariant;
  // Shared
  userName?: string;
  signatureState?: 'unsigned' | 'signed' | 'signed-as';
  signedName?: string;
...
export function AXSignatureCapture({
  variant,
  userName,
  signatureState,
  signedName,
