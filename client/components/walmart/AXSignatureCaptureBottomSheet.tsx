...
import { SignatureBase, SignatureBaseProps } from './AXSignatureCapture';

// ── AXSignatureCaptureBottomSheet ─────────────────────────────────────────
...
export interface AXSignatureCaptureBottomSheetProps extends SignatureBaseProps {
...
export function AXSignatureCaptureBottomSheet({
  isOpen,
  onClose,
  ...
  ...signatureBaseProps
}: AXSignatureCaptureBottomSheetProps) {
  return (
    <BottomSheet
      isOpen={isOpen}
      onClose={onClose}
