...
import { AXTimerView, TimerViewVariant } from '@/components/walmart/AXTimerView';
...
export interface AXQueueBannerProps {
  /** Banner variant */
...
export function AXQueueBanner(props: AXQueueBannerProps) {
  const {
    variant,
    timeDisplay,
    snackbarText,
