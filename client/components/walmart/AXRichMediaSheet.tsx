 ...
 * Distinct from the LD BottomSheet — designed for product-level AX use cases
...
export type AXRichMediaSheetHeaderVariant =
  | 'title'
  | 'title-subtitle'
  | 'logo-left'
  | 'logo-center'
...
export type AXRichMediaSheetSurfaceVariant = 'default' | 'brand' | 'brand-bold' | 'brand-gradient' | 'media';

export interface AXRichMediaSheetProps {
   ...
   * @default 'title'
   */
  headerVariant?: AXRichMediaSheetHeaderVariant;
   ...
   * @default 'default'
   */
  surfaceVariant?: AXRichMediaSheetSurfaceVariant;
...
interface HeaderProps {
  variant: AXRichMediaSheetHeaderVariant;
  title?: string;
  subtitle?: string;
  logoSlot?: React.ReactNode;
  onClose: () => void;
...
export function AXRichMediaSheet({
  isOpen,
  onClose,
  headerVariant = 'title',
  title,
