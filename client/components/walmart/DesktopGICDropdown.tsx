  ...
  return (
    <>
      ...
      <div ref={dropdownRef} className="absolute top-full left-0 mt-2 w-[314px] rounded-b-2xl shadow-none z-[100] overflow-hidden">
        ...
        <div className="pt-6 pb-5 px-0" style={{ backgroundColor: 'var(--ld-semantic-color-action-fill-primary, #0053E2)' }}>
        ...
        <div className="px-4 pb-4" style={{ backgroundColor: 'var(--ld-semantic-color-action-fill-primary, #0053E2)' }}>
          <div className="flex flex-col gap-2">
            <button className="w-full flex items-center gap-2 p-4 bg-white rounded-lg shadow-[0_-1px_2px_0_rgba(0,0,0,0.1),0_1px_2px_1px_rgba(0,0,0,0.15)]">
              ...
              <span className="flex-1 text-left text-[12px] leading-[16px]" style={{ color: 'var(--ld-semantic-color-text, #2E2F32)' }}>
            ...
            <button className="w-full flex items-center gap-2 p-4 bg-white rounded-lg shadow-[0_-1px_2px_0_rgba(0,0,0,0.1),0_1px_2px_1px_rgba(0,0,0,0.15)]">
              ...
              <div className="flex-1 text-left flex flex-col gap-1">
                <span className="text-[12px] font-semibold leading-[16px]" style={{ color: 'var(--ld-semantic-color-text, #2E2F32)' }}>Carrollton Supercenter</span>
                <span className="text-[12px] leading-[16px]" style={{ color: 'var(--ld-semantic-color-text, #2E2F32)' }}>1213 E Trinity Mills Rd, Dallas, TX 75220</span>
              </div>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
                <path d="M17.751 12.5652L8.53762 21L7.5 19.8695L16.096 12L7.5 4.13049L8.53762 3L17.751 11.4348C17.9097 11.58 18 11.7851 18 12C18 12.2149 17.9097 12.42 17.751 12.5652Z" fill="black"/>
              </svg>
