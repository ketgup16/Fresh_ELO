...
import { AXCountry, AX_DEFAULT_COUNTRIES } from './AXCountrySelectBottomSheet';
import styles from './AXCountrySelectDropdown.module.css';

export interface AXCountrySelectDropdownProps {
  ...
  onChange?: (value: string | string[], countries: AXCountry | AXCountry[]) => void;
...
export function AXCountrySelectDropdown({
  ...
  const handleSingleSelect = (country: AXCountry) => {
  ...
  const handleMultiToggle = (country: AXCountry) => {
