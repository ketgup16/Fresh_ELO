...
import styles from './AXCountrySelectGroup.module.css';

export interface AXCountrySelectGroupProps {
  /** Countries to display */
  countries?: AXCountry[];
  /** Selected country code */
  value?: string;
  /** Called when a country is selected */
  onChange?: (country: AXCountry) => void;
...
export function AXCountrySelectGroup({
