...
import styles from './WCPSearchField.module.css';

export type WCPSearchFieldState = 'enabled' | 'disabled' | 'readOnly';

interface WCPSearchFieldProps {
  value?: string;
  placeholder?: string;
  state?: WCPSearchFieldState;
  showMic?: boolean;
  showBarcode?: boolean;
...
export function WCPSearchField({
  value = '',
  placeholder = 'Search',
  state = 'enabled',
  showMic = true,
