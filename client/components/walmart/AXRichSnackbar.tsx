...
export type AXRichSnackbarColor = 'primary' | 'secondary' | 'inverse' | 'brand';
export type AXRichSnackbarContentVariant =
  | 'left-regular'
  | 'left-bold'
  | 'center-regular'
  | 'center-bold';

export interface AXRichSnackbarProps {
  id?: string;
  open?: boolean;
...
export const AXRichSnackbar: React.FC<AXRichSnackbarProps> = ({
  id,
  open = true,
  color = 'primary',
