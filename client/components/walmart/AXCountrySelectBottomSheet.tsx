...
import styles from './AXCountrySelectBottomSheet.module.css';

export interface AXCountry {
...
export const AX_DEFAULT_COUNTRIES: AXCountry[] = [
  {
    code: 'CA-NQ',
    abbr: 'CA',
...
export interface AXCountrySelectBottomSheetProps {
  /** List of countries to display */
  countries?: AXCountry[];
  /** Currently selected country code */
  value?: string;
  /** Called when a country is selected */
  onSelect?: (country: AXCountry) => void;
  ...
  onConfirm?: (selected: AXCountry | undefined) => void;
...
export function AXCountrySelectBottomSheet({
  ...
  onClose,
  open,
}: AXCountrySelectBottomSheetProps) {
  ...
  const handleSelect = (country: AXCountry) => {
