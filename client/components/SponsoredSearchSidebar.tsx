      ...
      icon: (isActive: boolean) => (
        <div className="flex flex-col items-start relative">
          <div className="w-4 h-4 relative">
            <div className="w-[14px] h-[14px] absolute left-[1px] top-[1px]">
              <div
                className="w-4 h-4 absolute left-[-1px] top-[-1px]"
                style={{ background: isActive ? '#0053E2' : '#2E2F32' }}
              />
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col items-start gap-1 p-3">
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              <div className="flex w-4 h-4 justify-center items-center relative">
                {item.icon(isActive)}
              </div>
            </button>
          );
