...
const AnalyticsIcon = ({ isActive }: { isActive: boolean }) => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 5.5H4C4.27614 5.5 4.5 5.72386 4.5 6V14C4.5 14.2761 4.27614 14.5 4 14.5H2C1.72386 14.5 1.5 14.2761 1.5 14V6C1.5 5.72386 1.72386 5.5 2 5.5ZM7 7.5H9C9.27614 7.5 9.5 7.72386 9.5 8V14C9.5 14.2761 9.27614 14.5 9 14.5H7C6.72386 14.5 6.5 14.2761 6.5 14V8C6.5 7.72386 6.72386 7.5 7 7.5ZM12 1.5H14C14.2761 1.5 14.5 1.72386 14.5 2V14C14.5 14.2761 14.2761 14.5 14 14.5H12C11.7239 14.5 11.5 14.2761 11.5 14V2C11.5 1.72386 11.7239 1.5 12 1.5Z" stroke={isActive ? '#0053E2' : '#2E2F32'}/>
  </svg>
);

const VideoArrowUpIcon = ({ isActive }: { isActive: boolean }) => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path fillRule="evenodd" clipRule="evenodd" d="M8 6.38376V6C8 4.34315 6.65685 3 5 3C3.34315 3 2 4.34315 2 6C2 6.76152 2.28243 7.45464 2.74974 7.98409L3 8.26763V8.30961L3.50073 8.59927C3.94097 8.85393 4.45191 9 5 9C6.39651 9 7.57246 8.04488 7.90555 6.75074L8 6.38376ZM3 10.5837V12C3 12.5523 3.44772 13 4 13H10C10.5523 13 11 12.5523 11 12V11.1535V9.12329V8C11 7.44772 10.5523 7 10 7H9H8.87398C8.42994 8.72523 6.86384 10 5 10C4.6547 10 4.31962 9.95625 4 9.87398C3.64523 9.78267 3.30951 9.64391 3 9.46487V10.5837ZM12 12V11.875L14.3244 12.7467C14.6513 12.8692 15 12.6276 15 12.2785V7.77329C15 7.41046 14.6257 7.16844 14.2948 7.31733L12 8.35V8C12 6.89543 11.1046 6 10 6H9C9 3.79086 7.20914 2 5 2C2.79086 2 1 3.79086 1 6C1 7.01445 1.37764 7.94069 2 8.64582V9.46487V12C2 13.1046 2.89543 14 4 14H10C11.1046 14 12 13.1046 12 12ZM14 11.557L12 10.807V9.44659L14 8.54659V11.557ZM3.23222 5.76778C3.03695 5.96305 3.03695 6.27963 3.23222 6.47489C3.42748 6.67015 3.74406 6.67015 3.93932 6.47489L4.46448 5.94974V7.49998C4.46448 7.77613 4.68834 7.99998 4.96448 7.99998C5.24062 7.99998 5.46448 7.77613 5.46448 7.49998V5.87873L6.06064 6.47489C6.2559 6.67015 6.57249 6.67015 6.76775 6.47489C6.96301 6.27963 6.96301 5.96305 6.76775 5.76778L5.35354 4.35357C5.15827 4.15831 4.84169 4.15831 4.64643 4.35357L3.23222 5.76778Z" fill={isActive ? '#0053E2' : '#2E2F32'}/>
  </svg>
);

const CloudUploadIcon = ({ isActive }: { isActive: boolean }) => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path fillRule="evenodd" clipRule="evenodd" d="M8.5 1C10.433 1 12 2.567 12 4.5C12 4.67 11.99 4.837 11.971 5H12C13.657 5 15 6.343 15 8C15 9.657 13.657 11 12 11H11.5V10H12C13.105 10 14 9.105 14 8C14 6.895 13.105 6 12 6H11V5.5C11 3.567 9.433 2 7.5 2C5.567 2 4 3.567 4 5.5V6H3.5C2.672 6 2 6.672 2 7.5C2 8.328 2.672 9 3.5 9H5V10H3.5C2.119 10 1 8.881 1 7.5C1 6.119 2.119 5 3.5 5H3.971C3.99 4.837 4 4.67 4 4.5C4 2.567 5.567 1 7.5 1H8.5ZM8 7V13H7V7H4.5L7.5 4L10.5 7H8Z" fill={isActive ? '#0053E2' : '#2E2F32'}/>
  </svg>
);
