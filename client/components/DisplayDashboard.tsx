    ...
    <div className="flex-1 overflow-y-auto bg-[#F8F8F8]">
      ...
      <div className="px-6 pb-6 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col bg-white rounded-lg border border-[#E3E4E5] shadow-[0_-1px_2px_0_rgba(0,0,0,0.10),0_1px_2px_1px_rgba(0,0,0,0.15)]">
              <div className="px-6 pt-3 pb-4">
                ...
                <div className="mb-4">
                  <div className="flex items-end gap-1 mb-2">
                    <span className="text-base font-bold text-[#2A8703]">23%-25%</span>
        ...
        <div className="flex items-center gap-2">
          <button className="h-10 px-4 border border-[#74767C] rounded bg-white flex items-center gap-2 text-sm text-[#2E2F32] hover:bg-gray-50 transition-colors">
            14 day attribution
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          ...
          <button className="h-10 px-4 border border-[#74767C] rounded bg-white flex items-center gap-2 text-sm text-[#2E2F32] hover:bg-gray-50 transition-colors min-w-[225px]">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_562px] gap-6">
          ...
          <div className="bg-white rounded-lg shadow-[0_-1px_2px_0_rgba(0,0,0,0.10),0_1px_2px_1px_rgba(0,0,0,0.15)] overflow-hidden">
            ...
            <div className="px-6 pb-6">
              ...
              {/* Chart Placeholder */}
              <div className="relative h-[320px] border-l border-b border-[#E3E4E5]">
                {/* Y-axis labels (left) */}
                <div className="absolute -left-10 top-0 bottom-0 flex flex-col justify-between text-right text-xs text-[#2E2F32] pb-4">
                  <span>$50K</span>
                  <span>$45K</span>
                  <span>$40K</span>
                  <span>$35K</span>
                ...
                {/* Y-axis labels (right) */}
                <div className="absolute -right-10 top-0 bottom-0 flex flex-col justify-between text-left text-xs text-[#993EF4] pb-4">
                  <span>$10.00</span>
                  <span>$9.00</span>
                  <span>$8.00</span>
                  <span>$7.00</span>
                ...
                {/* X-axis labels */}
                <div className="absolute -bottom-6 left-0 right-0 flex justify-between text-xs text-[#2E2F32] px-4">
                  <span>Oct 4</span>
                  <span>Oct 7</span>
                  <span>Oct 10</span>
                  <span>Oct 13</span>
                ...
                {/* Chart SVG */}
                <svg className="w-full h-full" viewBox="0 0 584 288" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <linearGradient id="paint0_linear" x1="311.906" y1="81.9307" x2="311.906" y2="237.699" gradientUnits="userSpaceOnUse">
                      <stop stopColor="#4DBDF5" stopOpacity="0.12"/>
                      <stop offset="1" stopColor="#4DBDF5" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="paint1_linear" x1="253.806" y1="88.7671" x2="253.806" y2="190.356" gradientUnits="userSpaceOnUse">
                      <stop stopColor="#993EF4" stopOpacity="0.12"/>
                      <stop offset="1" stopColor="#993EF4" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="paint2_linear" x1="298.528" y1="59.1782" x2="298.528" y2="287.999" gradientUnits="userSpaceOnUse">
                      <stop stopColor="#0053E2" stopOpacity="0.12"/>
                      <stop offset="1" stopColor="#0053E2" stopOpacity="0"/>
                    </linearGradient>
                  </defs>
                  <g clipPath="url(#clip0)">
                    <path d="M104.449 224.322C50.4019 224.322 10.2535 184.666 0 174.477V237.699H584V175.987C511.973 177.921 534.234 81.2892 494.292 81.9339C454.35 82.5786 484.056 220.633 387.801 220.633C336.226 220.633 329.176 196.522 257.193 196.522C199.309 196.522 157.408 224.322 104.449 224.322Z" fill="url(#paint0_linear)"/>
                    ...
                    <path d="M102.051 177.658C71.3618 177.383 21.2298 118.283 0 88.7671V190.356H584V180.06C559.418 169.878 494.24 148.76 430.179 145.739C350.102 141.964 351.964 157.065 303.546 157.065C246.561 158.095 248.796 142.65 203.73 143.337C158.663 144.023 140.413 178.001 102.051 177.658Z" fill="url(#paint1_linear)"/>
                    ...
                    <path d="M102.761 82.2171C74.0553 42.1341 27.4994 88.8639 0 146.47V287.999H584V118.221C529.242 120.99 517.454 213.798 483.305 212.591C453.264 213.359 425.855 55.9067 387.742 59.2301C349.628 62.5535 355.259 139.269 299.599 139.269C252.56 129.853 249.907 85.5405 197.079 111.574C150.916 134.323 138.449 132.05 102.761 82.2171Z" fill="url(#paint2_linear)"/>
                ...
                {/* Additional Y-axis labels for Spend (cyan) */}
                <div className="absolute -right-10 top-0 bottom-0 flex flex-col justify-between text-left text-xs text-[#4DBDF5] pb-4" style={{ marginRight: '-70px' }}>
                  <span>$8K</span>
                  <span></span>
                  <span>$6K</span>
                  <span></span>
              ...
              <div className="flex items-center gap-6">
                <div className="relative w-[200px] h-[200px] flex-shrink-0">
                  ...
                  <svg className="w-full h-full" viewBox="0 0 308 308" fill="none">
                    ...
                    <path d="M154 0C184.458 0 214.233 9.03194 239.558 25.9537C264.883 42.8754 284.622 66.9269 296.277 95.0667C307.933 123.207 310.983 154.171 305.041 184.044C299.099 213.917 284.432 241.357 262.894 262.894C241.357 284.432 213.917 299.099 184.044 305.041C154.171 310.983 123.207 307.933 95.0668 296.277C66.9269 284.622 42.8754 264.883 25.9537 239.558C9.03195 214.233 0 184.458 0 154L61.6 154C61.6 172.275 67.0192 190.14 77.1722 205.335C87.3253 220.53 101.756 232.373 118.64 239.366C135.524 246.36 154.103 248.19 172.026 244.625C189.95 241.059 206.414 232.259 219.337 219.337C232.259 206.414 241.059 189.95 244.625 172.026C248.19 154.102 246.36 135.524 239.366 118.64C232.373 101.756 220.53 87.3252 205.335 77.1722C190.14 67.0192 172.275 61.6 154 61.6L154 0Z" fill="#993EF4" stroke="#993EF4" strokeWidth="2" mask="url(#path-2-inside-2)"/>
                    ...
                    <path d="M154 0C180.759 0 207.057 6.97264 230.301 20.2307C253.545 33.4888 272.933 52.5748 286.554 75.6076C300.176 98.6404 307.561 124.825 307.981 151.581C308.401 178.337 301.843 204.741 288.951 228.19C276.06 251.639 257.281 271.325 234.465 285.307C211.649 299.288 185.583 307.083 158.837 307.924C132.091 308.765 105.588 302.621 81.9389 290.1C58.2899 277.578 38.3119 259.111 23.9735 236.517L75.9841 203.51C84.5871 217.067 96.574 228.147 110.763 235.66C124.953 243.173 140.855 246.859 156.902 246.354C172.95 245.85 188.589 241.173 202.279 232.784C215.968 224.395 227.236 212.584 234.971 198.514C242.706 184.444 246.641 168.602 246.389 152.549C246.136 136.495 241.706 120.784 233.533 106.965C225.36 93.1449 213.727 81.6933 199.78 73.7384C185.834 65.7836 170.056 61.6 154 61.6L154 0Z" fill="#0053E2" stroke="#0053E2" strokeWidth="2" mask="url(#path-3-inside-3)"/>
          ...
          <div className="bg-white rounded-lg shadow-[0_-1px_2px_0_rgba(0,0,0,0.10),0_1px_2px_1px_rgba(0,0,0,0.15)] overflow-hidden">
            <div className="px-6 pt-6">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="relative w-[200px] h-[200px] flex-shrink-0">
                  <svg className="w-full h-full" viewBox="0 0 308 308" fill="none">
                    <mask id="segment-23" fill="white">
                      <path d="M308 154C308 68.9481 239.052 0 154 0C68.9481 0 0 68.9481 0 154C0 239.052 68.9481 308 154 308C239.052 308 308 239.052 308 154ZM61.6 154C61.6 102.969 102.969 61.6 154 61.6C205.031 61.6 246.4 102.969 246.4 154C246.4 205.031 205.031 246.4 154 246.4C102.969 246.4 61.6 205.031 61.6 154Z"/>
                    </mask>
                    <path d="M308 154C308 68.9481 239.052 0 154 0C68.9481 0 0 68.9481 0 154C0 239.052 68.9481 308 154 308C239.052 308 308 239.052 308 154ZM61.6 154C61.6 102.969 102.969 61.6 154 61.6C205.031 61.6 246.4 102.969 246.4 154C246.4 205.031 205.031 246.4 154 246.4C102.969 246.4 61.6 205.031 61.6 154Z" fill="#001E60" stroke="#001E60" strokeWidth="2" mask="url(#segment-23)"/>
                    
                    <mask id="segment-9" fill="white">
                      <path d="M154 0C184.458 0 214.233 9.03194 239.558 25.9537C264.883 42.8754 284.622 66.9269 296.277 95.0667C307.933 123.207 310.983 154.171 305.041 184.044C299.099 213.917 284.432 241.357 262.894 262.894C241.357 284.432 213.917 299.099 184.044 305.041C154.171 310.983 123.207 307.933 95.0668 296.277C66.9269 284.622 42.8754 264.883 25.9537 239.558C9.03195 214.233 0 184.458 0 154L61.6 154C61.6 172.275 67.0192 190.14 77.1722 205.335C87.3253 220.53 101.756 232.373 118.64 239.366C135.524 246.36 154.103 248.19 172.026 244.625C189.95 241.059 206.414 232.259 219.337 219.337C232.259 206.414 241.059 189.95 244.625 172.026C248.19 154.102 246.36 135.524 239.366 118.64C232.373 101.756 220.53 87.3252 205.335 77.1722C190.14 67.0192 172.275 61.6 154 61.6L154 0Z"/>
                    </mask>
                    <path d="M154 0C184.458 0 214.233 9.03194 239.558 25.9537C264.883 42.8754 284.622 66.9269 296.277 95.0667C307.933 123.207 310.983 154.171 305.041 184.044C299.099 213.917 284.432 241.357 262.894 262.894C241.357 284.432 213.917 299.099 184.044 305.041C154.171 310.983 123.207 307.933 95.0668 296.277C66.9269 284.622 42.8754 264.883 25.9537 239.558C9.03195 214.233 0 184.458 0 154L61.6 154C61.6 172.275 67.0192 190.14 77.1722 205.335C87.3253 220.53 101.756 232.373 118.64 239.366C135.524 246.36 154.103 248.19 172.026 244.625C189.95 241.059 206.414 232.259 219.337 219.337C232.259 206.414 241.059 189.95 244.625 172.026C248.19 154.102 246.36 135.524 239.366 118.64C232.373 101.756 220.53 87.3252 205.335 77.1722C190.14 67.0192 172.275 61.6 154 61.6L154 0Z" fill="#993EF4" stroke="#993EF4" strokeWidth="2" mask="url(#segment-9)"/>
                    
                    <mask id="segment-18" fill="white">
                      <path d="M154 0C180.759 0 207.057 6.97264 230.301 20.2307C253.545 33.4888 272.933 52.5748 286.554 75.6076C300.176 98.6404 307.561 124.825 307.981 151.581C308.401 178.337 301.843 204.741 288.951 228.19C276.06 251.639 257.281 271.325 234.465 285.307C211.649 299.288 185.583 307.083 158.837 307.924C132.091 308.765 105.588 302.621 81.9389 290.1C58.2899 277.578 38.3119 259.111 23.9735 236.517L75.9841 203.51C84.5871 217.067 96.574 228.147 110.763 235.66C124.953 243.173 140.855 246.859 156.902 246.354C172.95 245.85 188.589 241.173 202.279 232.784C215.968 224.395 227.236 212.584 234.971 198.514C242.706 184.444 246.641 168.602 246.389 152.549C246.136 136.495 241.706 120.784 233.533 106.965C225.36 93.1449 213.727 81.6933 199.78 73.7384C185.834 65.7836 170.056 61.6 154 61.6L154 0Z"/>
                    </mask>
                    <path d="M154 0C180.759 0 207.057 6.97264 230.301 20.2307C253.545 33.4888 272.933 52.5748 286.554 75.6076C300.176 98.6404 307.561 124.825 307.981 151.581C308.401 178.337 301.843 204.741 288.951 228.19C276.06 251.639 257.281 271.325 234.465 285.307C211.649 299.288 185.583 307.083 158.837 307.924C132.091 308.765 105.588 302.621 81.9389 290.1C58.2899 277.578 38.3119 259.111 23.9735 236.517L75.9841 203.51C84.5871 217.067 96.574 228.147 110.763 235.66C124.953 243.173 140.855 246.859 156.902 246.354C172.95 245.85 188.589 241.173 202.279 232.784C215.968 224.395 227.236 212.584 234.971 198.514C242.706 184.444 246.641 168.602 246.389 152.549C246.136 136.495 241.706 120.784 233.533 106.965C225.36 93.1449 213.727 81.6933 199.78 73.7384C185.834 65.7836 170.056 61.6 154 61.6L154 0Z" fill="#0053E2" stroke="#0053E2" strokeWidth="2" mask="url(#segment-18)"/>
                    
                    <mask id="segment-48" fill="white">
                    ...
                    <path d="M154 0C193.169 0 230.867 14.9255 259.42 41.7388C287.974 68.5521 305.237 105.238 307.696 144.33C310.156 183.422 297.627 221.983 272.659 252.163C247.692 282.344 212.162 301.876 173.301 306.786L165.581 245.671C188.897 242.726 210.215 231.006 225.195 212.898C240.176 194.79 247.693 171.653 246.218 148.198C244.742 124.743 234.384 102.731 217.252 86.6433C200.12 70.5553 177.502 61.6 154 61.6L154 0Z" fill="#4DBDF5" stroke="#4DBDF5" strokeWidth="2" mask="url(#segment-48)"/>
                  </svg>
                  
                  {/* Center Text */}
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <div className="text-2xl font-bold text-[#2E2F32]">290.2k</div>
                    <div className="text-lg text-[#2E2F32]">Overall</div>
                  </div>
                </div>
