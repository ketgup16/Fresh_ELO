...
const PRODUCTS = [
  { flag: 'Deal', flagBg: '#0E002E', price: '1,179', cents: '00', wasPrice: '$2,499.00', name: 'SAMSUNG 55" Class S90C OLED 4K Smart TV QN55S90CAFXZA 2023', cue: 'TV with bright screen', rating: '500', pickup: '2 pm', stock: 'Only 6 left' },
  { flag: 'Rollback', flagBg: '#EA1100', price: '498', cents: '00', wasPrice: '$699.99', name: 'LG 55" Class QNED 4K LED QNED85T series TV with webOS 24', cue: 'TV with bright screen', rating: '151', pickup: '2 pm', stock: '' },
];
          ...
          <div className="w-[173px] h-[233px] flex-shrink-0 relative rounded-l-lg">
            {product.flag && (
              <div className="absolute top-1 left-2 z-10">
                <div style={{ backgroundColor: product.flagBg }} className="px-2 py-1 rounded text-[12px] font-bold text-white">
                  {product.flag}
                </div>
              </div>
            )}
          ...
          <div className="flex-1 flex flex-col gap-1">
            ...
            {product.cue && (
              <div className="flex items-center gap-1">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M8 2L6 6H2L5.5 9L4 13L8 10.5L12 13L10.5 9L14 6H10L8 2Z" fill="#FFC220"/></svg>
            ...
            <div className="flex items-center gap-1">
              <div className="flex gap-[2px]">
                {[1, 2, 3, 4].map((j) => (
                  <svg key={j} width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M6 1L7.5 4.5L11 5L8.5 7.5L9 11L6 9L3 11L3.5 7.5L1 5L4.5 4.5L6 1Z" fill="#FFC220"/></svg>
                ))}
              </div>
