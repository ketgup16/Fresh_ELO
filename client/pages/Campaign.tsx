          ...
          <div className="flex flex-col gap-6 pt-4">
            ...
            <div className="bg-white rounded-lg shadow-[0_-1px_2px_0_rgba(0,0,0,0.10),0_1px_2px_1px_rgba(0,0,0,0.15)] h-[628px] flex flex-col">
              ...
              <div className="px-6 py-6 border-b border-[#E3E4E5] flex items-center gap-3">
                <h3 className="text-lg font-semibold text-[#2E2F32] leading-[25px]">Items</h3>
                <div className="inline-flex px-2 py-1 bg-[#E9F1FE] rounded-sm">
                  <span className="text-xs text-[#002E99] leading-4">Ad group: SpookySoaps</span>
                </div>
              </div>
                          ...
                          <div key={idx} className="flex items-center gap-3 px-4 py-2 border-b border-[#E3E4E5]">
                            ...
                            <div className="w-14">
                              <div className="relative h-[18px] w-14 flex items-center">
                                <span className="absolute left-1.5 text-xs text-[#515357] pointer-events-none">$</span>
                                <input
                                  type="text"
                                  defaultValue="3.91"
                                  className="w-full h-full pl-5 pr-1 text-xs border border-[#C7C8CB] rounded bg-white"
                                />
                              </div>
                            </div>
                            <div className="w-12">
