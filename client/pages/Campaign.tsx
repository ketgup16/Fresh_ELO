      ...
      <header className="h-[54px] border-b border-[#E3E4E5] flex items-center justify-between px-6 bg-white">
        <div className="flex items-center gap-5">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="w-px h-[22px] bg-[#E3E4E5]"></div>
            <div className="flex items-center gap-1 text-sm">
              <span className="text-[#2E2F32]">Free Reign Coffee</span>
              <ChevronDown className="w-4 h-4" />
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1 text-sm">
            <span className="text-[#2E2F32]">English</span>
            <ChevronDown className="w-4 h-4" />
          </div>
          <button className="flex items-center gap-1 text-sm hover:bg-gray-100 px-2 py-1 rounded">
            <MessageSquare className="w-4 h-4" />
            <span className="text-[#2E2F32]">Feedback</span>
          </button>
          <button className="flex items-center gap-1 text-sm hover:bg-gray-100 px-2 py-1 rounded">
            <HelpCircle className="w-4 h-4" />
            <span className="text-[#2E2F32]">Help</span>
          </button>
          <button className="flex items-center gap-1 text-sm hover:bg-gray-100 px-2 py-1 rounded">
            <User className="w-4 h-4" />
            <span className="text-[#2E2F32]">Account</span>
          </button>
        </div>
      </header>
