          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-3 gap-6">
                ...
                <Button variant="outline" className="flex flex-col items-start gap-2 pt-4 h-auto border border-[#E3E4E5] rounded bg-white hover:border-[#0071DC] hover:bg-gray-50 text-left">
                  <div className="text-xs font-bold text-[#515357] leading-4 px-4">Sponsored Brands</div>
                  <div className="text-sm text-[#515357] leading-5 px-4">This premium ad sends your brand and products to the top of relevant results when customers search our site & app.</div>
                  <div className="w-full mt-auto px-4 pb-4">
                    <SponsoredBrandsCard />
                  </div>
                </Button>
                <Button variant="outline" className="flex flex-col items-start gap-2 pt-4 h-auto border border-[#E3E4E5] rounded bg-white hover:border-[#0071DC] hover:bg-gray-50 text-left">
                  <div className="text-xs font-bold text-[#515357] leading-4 px-4">Sponsored Videos</div>
                  <div className="text-sm text-[#515357] leading-5 px-4">Have your ads show up in the premium video ad slot.</div>
                  <div className="w-full mt-auto px-4 pb-4">
                    <SponsoredVideosCard />
                  </div>
                </Button>
