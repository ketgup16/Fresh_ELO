    ...
    <div style={{ padding: '48px', maxWidth: '1400px', margin: '0 auto' }}>
      <div style={{ marginBottom: '32px' }}>
        ...
        <p style={{ fontSize: '16px', lineHeight: '1.6', color: 'var(--ld-semantic-color-text-secondary, #74767C)', maxWidth: '800px' }}>
          A visual indicator that displays the completion status of a task or process. Use Progress Indicators to communicate system activity, loading states, file uploads, or task completion to users.
        </p>
      </div>
