    ...
    <div style={{ padding: '48px', maxWidth: '1400px', margin: '0 auto' }}>
      <div style={{ marginBottom: '32px' }}>
        ...
        <p style={{ fontSize: '16px', lineHeight: '1.6', color: 'var(--ld-semantic-color-text-secondary, #74767C)', maxWidth: '800px' }}>
          A visual representation of a user's progress through a set of steps. Progress Trackers show the steps of a process and highlight completed, current, and future steps. They can be used for both user and system tasks.
        </p>
      </div>
