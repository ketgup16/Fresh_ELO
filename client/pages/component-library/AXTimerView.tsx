...
export default function AXTimerViewPage() {
  return (
    <ComponentPageLayout
    ...
    >
        ...
        <div className={styles.demoGrid}>
          <DemoCard label="Waiting (Light Blue)">
            <div className={styles.timerRow}>
              <AXTimerView timeDisplay="57mins" variant="waiting" size="medium" />
          ...
          <DemoCard label="Warning (Yellow)">
            <div className={styles.timerRow}>
              <AXTimerView timeDisplay="10:23" variant="warning" size="medium" />
          ...
          <DemoCard label="Expiring (Red)">
            <div className={styles.timerRow}>
              <AXTimerView timeDisplay="01:03" variant="expiring" size="medium" />
              <span className={styles.metaLabel}>left to buy</span>
            </div>
          </DemoCard>
        </div>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.demoGrid}>
          <DemoCard label="Medium (default)">
            <div className={styles.timerRow}>
              <AXTimerView timeDisplay="59mins" variant="waiting" size="medium" />
              <AXTimerView timeDisplay="10:23" variant="warning" size="medium" />
              <AXTimerView timeDisplay="01:03" variant="expiring" size="medium" />
            </div>
          </DemoCard>
          ...
          <DemoCard label="Small">
            <div className={styles.timerRow}>
              <AXTimerView timeDisplay="59mins" variant="waiting" size="small" />
              <AXTimerView timeDisplay="10:23" variant="warning" size="small" />
              <AXTimerView timeDisplay="01:03" variant="expiring" size="small" />
            </div>
          </DemoCard>
        </div>
      </div>
      ...
      <div className={styles.section}>
        ...
        <table className={styles.propTable}>
          ...
          <tbody>
            <tr>
              <td><code>AXTimerView</code></td>
              <td>@/components/walmart/AXTimerView</td>
            </tr>
          </tbody>
        </table>
      </div>
