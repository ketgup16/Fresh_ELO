...
import { AXTimerView } from '@/components/walmart/AXTimerView';
import { AXQueueCard } from '@/components/walmart/AXQueueCard';
import { AXQueueBanner } from '@/components/walmart/AXQueueBanner';
import { AXQueueLanding } from '@/components/walmart/AXQueueLanding';
import { Tag } from '@/components/ui/Tag';
import { PRODUCT_IMAGES } from '@/components/walmart/productImages';
import styles from './AXQueue.module.css';
...
export default function AXQueuePage() {
  return (
    <ComponentPageLayout
    ...
    >
        ...
        <div className={styles.demoGrid}>
          <DemoCard label="Waiting (Blue)">
            <div className={styles.timerRow}>
              <AXTimerView timeDisplay="57mins" variant="waiting" />
          ...
          <DemoCard label="Warning (Yellow)">
            <div className={styles.timerRow}>
              <AXTimerView timeDisplay="10:23" variant="warning" />
          ...
          <DemoCard label="Expiring (Red)">
            <div className={styles.timerRow}>
              <AXTimerView timeDisplay="01:03" variant="expiring" />
              <span className={styles.metaLabel}>left to buy</span>
            </div>
          </DemoCard>
        </div>
      ...
      <div className={styles.section}>
        ...
        <PropTable
          ...
          rows={[
            ['AXTimerView', 'Primitive', '@/components/walmart/AXTimerView'],
            ['AXQueueCard', 'Card', '@/components/walmart/AXQueueCard'],
            ['AXQueueBanner', 'Banner', '@/components/walmart/AXQueueBanner'],
            ['AXQueueLanding', 'Landing', '@/components/walmart/AXQueueLanding'],
          ]}
        />
      </div>
    </ComponentPageLayout>
