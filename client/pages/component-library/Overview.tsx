...
const componentSections: ComponentEntry[] = [
  ...
  { titleKey: 'componentLibrary.navAXUploadImage', descKey: 'componentLibrary.descAXUploadImage', path: '/component-library/ax-upload-image', icon: 'Image', section: 'ld' },
  { titleKey: 'componentLibrary.navAXCountry', descKey: 'componentLibrary.descAXCountry', path: '/component-library/ax-country', icon: 'Circle', section: 'ld' },
...
const patternComponents: ComponentEntry[] = [
  ...
  { titleKey: 'componentLibrary.navSideNav', descKey: 'componentLibrary.descSideNav', path: '/component-library/mega-nav', icon: 'PanelLeft', section: 'ld' },
];
