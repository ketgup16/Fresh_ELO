    ...
    <div className={styles.reviewCard}>
      ...
      <div className={styles.reviewCardBody}>
        ...
        <div className={styles.reviewCardStars}>
          ...
          <AXRating value={0} size="medium" aria-label="Rate your Auto Care experience" />
        </div>
...
// ─── Page ─────────────────────────────────────────────────────────────────────
export default function AXRatingPage() {
  ...
  return (
    <ComponentPageLayout
      ...
      title="Ratings"
      description="Two complementary rating components: an interactive star picker (AXRating) for collecting user feedback, and a read-only aggregate display (AXRatingDisplay) for item tiles and review sections."
    >
      <div className={styles.content}>

        {/* ══════════════════════════════════════════════════════════════════
            PART 1 — INTERACTIVE RATING (AXRating)
        ══════════════════════════════════════════════════════════════════ */}
        <div className={styles.componentBlock}>
          <div className={styles.componentBlockHeader}>
            <div>
              ...
              <p className={styles.componentBlockSubtitle}>
                <code>AXRating</code> — allows users to select a 1–5 star rating. Supports
            ...
            <div className={styles.sizesGrid}>
              <DemoCard title="Small">
                <div className={styles.ratingsRow}>
                  {[0, 1, 2, 3, 4, 5].map((v) => (
                    <AXRating size="small" defaultValue={v} key={`small-${v}`} />
                  ))}
                </div>
              </DemoCard>
              <DemoCard title="Medium">
                <div className={styles.ratingsRow}>
                  {[0, 1, 2, 3, 4, 5].map((v) => (
                    <AXRating size="medium" defaultValue={v} key={`medium-${v}`} />
                  ))}
                </div>
              </DemoCard>
            </div>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.statesGrid}>
              <DemoCard title="Default (Unrated)">
                <div className={styles.stateItem}><AXRating size="medium" defaultValue={0} /></div>
              </DemoCard>
              <DemoCard title="With selection (Good — 4 stars)">
                <div className={styles.stateItem}><AXRating size="medium" defaultValue={4} /></div>
              </DemoCard>
              <DemoCard title="Disabled (Unrated)">
                <div className={styles.stateItem}><AXRating size="medium" defaultValue={0} disabled /></div>
              </DemoCard>
              <DemoCard title="Disabled (3 stars)">
                <div className={styles.stateItem}><AXRating size="medium" defaultValue={3} disabled /></div>
              </DemoCard>
            </div>
          </section>
            ...
            <div className={styles.labelsTable}>
              ...
              {[0, 1, 2, 3, 4, 5].map((v) => (
                <div key={v} className={styles.labelsTableRow}>
                  ...
                  <AXRating size="small" value={v} aria-label={`${v} stars example`} />
                </div>
              ))}
            </div>
          </section>
          ...
          <section className={styles.section}>
            ...
            <pre className={styles.codeBlock}>{`import { AXRating } from '@/components/walmart/AXRating';

// Uncontrolled
<AXRating size="medium" defaultValue={0} onChange={(v) => console.log(v)} />

// Controlled
const [rating, setRating] = useState(0);
<AXRating size="medium" value={rating} onChange={setRating} />

// Disabled
<AXRating size="medium" value={4} disabled />`}
            </pre>
          </section>

          <section className={styles.section}>
            <SectionTitle>Props — AXRating</SectionTitle>
        ...
        {/* ══════════════════════════════════════════════════════════════════
            PART 2 — RATING DISPLAY (AXRatingDisplay)
        ══════════════════════════════════════════════════════════════════ */}
        <div className={styles.componentBlock}>
          <div className={styles.componentBlockHeader}>
            <div>
              ...
              <p className={styles.componentBlockSubtitle}>
                <code>AXRatingDisplay</code> — non-interactive aggregate display for item tiles
          ...
          <section className={styles.section}>
            ...
            <div className={styles.variantsGrid}>
              <div className={styles.variantBox}>
                ...
                <AXRating value={0} size="small" count="(1.5)" linkText="Link" text="Text string" />
              </div>
              <div className={styles.variantBox}>
                <span className={styles.variantLabel}>Default · Small · 2 stars</span>
                <AXRating value={2} size="small" count="(2.0)" linkText="Link" text="Text string" />
              </div>
              <div className={styles.variantBox}>
                <span className={styles.variantLabel}>Default · Medium · 0 stars</span>
                <AXRating value={0} size="medium" count="(1.5)" linkText="Link" text="Text string" />
              </div>
              <div className={styles.variantBox}>
                <span className={styles.variantLabel}>Default · Medium · 2 stars</span>
                <AXRating value={2} size="medium" count="(1.5)" linkText="Link" text="Text string" />
              </div>
              <div className={`${styles.variantBox} ${styles.variantBoxInverse}`}>
                ...
                <AXRating value={0} size="small" color="inverse" count="(1.5)" linkText="Link" text="Text string" />
              </div>
              <div className={`${styles.variantBox} ${styles.variantBoxInverse}`}>
                <span className={`${styles.variantLabel} ${styles.variantLabelInverse}`}>Inverse · Medium</span>
                <AXRating value={0} size="medium" color="inverse" count="(1.5)" linkText="Link" text="Text string" />
              </div>
            </div>
          </section>
              ...
              <div className={styles.afterCard}>
                ...
                <div className={styles.simpleTile}>
                  ...
                  <div className={styles.simpleTileBody}>
                    <p className={styles.simpleTileName}>Conventional Oil Change</p>
                    <AXRating value={4.7} size="small" count="(4.7)" linkText="12,451 reviews" />
                    <p className={styles.simpleTilePrice}>$19.88</p>
                  </div>
            ...
            <div className={styles.promptVariantsGrid}>
              <div className={styles.promptVariantCard}>
                ...
                <div className={styles.promptVariantDemo}>
                  <AXRating value={0} size="small" linkText="Rate your visit" text="takes 30 seconds" />
                </div>
              </div>
              <div className={styles.promptVariantCard}>
                ...
                <div className={styles.promptVariantDemo}>
                  <AXRating value={0} size="small" linkText="Leave a review" text="Not yet reviewed" />
                </div>
              </div>
              <div className={styles.promptVariantCard}>
                ...
                <div className={styles.promptVariantDemo}>
                  <AXRating value={0} size="small" count="(0)" linkText="Rate your Oil Change" />
                </div>
              </div>
              <div className={styles.promptVariantCard}>
                ...
                <div className={styles.promptVariantDemo}>
                  <AXRating value={4.7} size="medium" count="(4.7)" linkText="12,451 reviews" text="Verified bookings" />
                </div>
              </div>
            </div>
          </section>
          ...
          <section className={styles.section}>
            <SectionTitle>Usage</SectionTitle>
            <pre className={styles.codeBlock}>{`import { AXRatingDisplay } from '@/components/walmart/AXRatingDisplay';
...
<AXRating value={4.7} size="medium" count="(4.7)" linkText="12,451 reviews" />

// On a dark surface (inverse)
<AXRating value={4.7} size="small" color="inverse" count="(4.7)" linkText="Reviews" />`}
            </pre>
          </section>

          <section className={styles.section}>
            <SectionTitle>Props — AXRatingDisplay</SectionTitle>
            <div className={styles.propsTable}>
              <div className={styles.propsTableHeader}>
                <span>Prop</span><span>Type</span><span>Default</span><span>Description</span>
              </div>
