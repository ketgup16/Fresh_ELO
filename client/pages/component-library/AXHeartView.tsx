...
import styles from './AXHeartView.module.css';
...
export default function AXHeartViewPage() {
    ...
    >
      <div className={styles.content}>
          ...
          <div className={styles.statesGrid}>
            ...
            <DemoCard title="Medium (desktop 900px+)">
              <div className={styles.stateRow}>
                <div className={styles.stateItem}>
                  ...
                  <AXHeartView size="medium" listName="Amy's List" />
                </div>
                <div className={styles.stateItem}>
                  <StateLabel>Activated</StateLabel>
                  <AXHeartView size="medium" defaultActivated listName="Amy's List" />
                </div>
                <div className={styles.stateItem}>
                  <StateLabel>Disabled</StateLabel>
                  <AXHeartView size="medium" disabled listName="Amy's List" />
                </div>
                <div className={styles.stateItem}>
                  <StateLabel>Disabled + Active</StateLabel>
                  <AXHeartView size="medium" disabled defaultActivated listName="Amy's List" />
                </div>
              </div>
            </DemoCard>
            ...
            <DemoCard title="Small (mobile <900px)">
              <div className={styles.stateRow}>
                <div className={styles.stateItem}>
                  <StateLabel>Enabled</StateLabel>
                  <AXHeartView size="small" listName="Amy's List" />
                </div>
                <div className={styles.stateItem}>
                  <StateLabel>Activated</StateLabel>
                  <AXHeartView size="small" defaultActivated listName="Amy's List" />
                </div>
                <div className={styles.stateItem}>
                  <StateLabel>Disabled</StateLabel>
                  <AXHeartView size="small" disabled listName="Amy's List" />
                </div>
                <div className={styles.stateItem}>
                  <StateLabel>Disabled + Active</StateLabel>
                  <AXHeartView size="small" disabled defaultActivated listName="Amy's List" />
                </div>
              </div>
            </DemoCard>
          </div>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.responsiveDemo}>
            <div className={styles.responsiveItem}>
              ...
              <AXHeartView listName="Amy's List" onViewList={() => alert('View list')} />
            </div>
            <div className={styles.responsiveItem}>
              <StateLabel>Activated</StateLabel>
              <AXHeartView defaultActivated listName="Amy's List" onViewList={() => alert('View list')} />
            </div>
          </div>
        </section>
          ...
          <div className={styles.positionsGrid}>
            <div className={styles.positionCard}>
              <div className={styles.positionPreview}>
                <AXHeartView size="medium" listName="Amy's List" calloutPosition="left" />
              </div>
            ...
            <div className={styles.positionCard}>
              <div className={styles.positionPreview}>
                <AXHeartView size="medium" listName="Amy's List" calloutPosition="right" />
              </div>
              <div className={styles.positionMeta}>
            ...
            <div className={styles.positionCard}>
              <div className={styles.positionPreview}>
                <AXHeartView size="medium" listName="Amy's List" calloutPosition="bottom" />
              </div>
              <div className={styles.positionMeta}>
        ...
        <section className={styles.section}>
          ...
          <pre className={styles.codeBlock}>{`import { AXHeartView } from '@/components/walmart/AXHeartView';
