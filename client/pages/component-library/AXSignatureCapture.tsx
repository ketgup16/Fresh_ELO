...
export default function AXSignatureCapturePage() {
  // ── Trigger demo ─────────────────────────────────────────────────────────
    ...
    >
      <div className={styles.page}>
        ...
        <div className={styles.section}>
          ...
          <SectionDesc>
            The AX Signature Capture component covers the full subscription sign-off journey. It
        ...
        <div className={styles.section}>
          ...
          <SectionDesc>
            The <code>AXSignatureCapture</code> component is a unified wrapper that selects the
        ...
        <div className={styles.section}>
          ...
          <pre className={styles.codeBlock}>{`import { AXSignatureCapture } from '@/components/walmart/AXSignatureCapture';
// Or use sub-components directly:
import { SignatureTrigger, SignatureBase, SignatureTerms, SignatureReauth } from '@/components/walmart/AXSignatureCapture';
