      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ fontSize: '14px', lineHeight: '1.6', color: 'var(--ld-semantic-color-text-subtle)' }}>
                Before creating any new UI, check <code style={{ backgroundColor: 'var(--ld-semantic-color-fill-subtle)', padding: '2px 6px', borderRadius: '4px', fontSize: '13px' }}>client/components/ui/</code> for
                existing Living Design 3.5 components. Follow the principle: <strong>Reuse &gt; Adapt &gt; Create</strong>.
                Only build something new when no existing component or composition of components can solve the need.
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontWeight: '700', fontSize: '15px', marginBottom: '6px', color: 'var(--ld-semantic-color-text)' }}>
                Use Semantic Tokens -- Never Hard-Code Colors or Spacing
              </div>
              <div style={{ fontSize: '14px', lineHeight: '1.6', color: 'var(--ld-semantic-color-text-subtle)' }}>
                Every color, spacing value, elevation, and font must reference a Living Design semantic token
                (e.g. <code style={{ backgroundColor: 'var(--ld-semantic-color-fill-subtle)', padding: '2px 6px', borderRadius: '4px', fontSize: '13px' }}>var(--ld-semantic-color-action-fill-primary)</code>).
                Hard-coded hex values like <code style={{ backgroundColor: 'var(--ld-semantic-color-fill-subtle)', padding: '2px 6px', borderRadius: '4px', fontSize: '13px' }}>#0071DC</code> bypass
                theming capabilities and will break when themes or brands change.
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontWeight: '700', fontSize: '15px', marginBottom: '6px', color: 'var(--ld-semantic-color-text)' }}>
                Importing Figma Designs with the Builder.io Plugin
              </div>
              <div style={{ fontSize: '14px', lineHeight: '1.6', color: 'var(--ld-semantic-color-text-subtle)' }}>
                When pulling designs from Figma, use the <strong>Builder.io Figma plugin</strong> to convert frames into code.
                The plugin maps Figma components to our library -- but always verify the output: confirm that
                imported buttons resolve to <code style={{ backgroundColor: 'var(--ld-semantic-color-fill-subtle)', padding: '2px 6px', borderRadius: '4px', fontSize: '13px' }}>&lt;Button&gt;</code> from our library (not raw HTML),
                that colors map to semantic tokens (not hex), and that spacing uses LD token values. Treat the plugin output
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontWeight: '700', fontSize: '15px', marginBottom: '6px', color: 'var(--ld-semantic-color-text)' }}>
                Trust the Foundations & Theming Layer
              </div>
              <div style={{ fontSize: '14px', lineHeight: '1.6', color: 'var(--ld-semantic-color-text-subtle)' }}>
                Our components ship with built-in accessibility (focus rings, ARIA attributes, keyboard navigation),
                responsive behavior, and theme support. Do not override these with custom CSS or inline styles.
                If a component variant doesn't exist for your use case, propose adding it to the library rather
                than creating a one-off workaround. This keeps the system extensible and maintainable.
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontWeight: '700', fontSize: '15px', marginBottom: '6px', color: 'var(--ld-semantic-color-text)' }}>
                AI-Generated Code Must Follow the Same Rules
              </div>
              <div style={{ fontSize: '14px', lineHeight: '1.6', color: 'var(--ld-semantic-color-text-subtle)' }}>
                Whether code is written by hand, generated by AI, or imported from Figma via Builder.io -- the
                same standards apply. AI agents are configured with rules that enforce library usage, token-based
                styling, and component reuse. Review all generated output to confirm it references our canonical
                components, uses semantic tokens, and follows the import conventions documented in the Code Standards tab below.
              </div>
            </div>
          </div>
        </div>
