    ...
    <div style={{ padding: '48px', maxWidth: '1400px', margin: '0 auto' }}>
      <div style={{ marginBottom: '32px' }}>
        ...
        <p style={{ fontSize: '16px', lineHeight: '1.6', color: 'var(--ld-semantic-color-text-secondary, #74767C)', maxWidth: '800px' }}>
          A non-modal dialog that displays supporting content anchored to a trigger. Use for instructions, short lists of options, and lightweight actions without taking the user away from the current context.
        </p>
      </div>
