...
import { AXQueuePanel } from '@/components/walmart/AXQueuePanel';
import type { QueueItem } from '@/components/walmart/AXQueueItemCard';
...
import styles from './AXQueueBanner.module.css';
...
export default function AXQueueBannerPage() {
    ...
    >
      <div className={styles.page}>
        ...
        <div className={styles.section}>
          ...
          <SectionDesc>
            Pair the queue banner with a <strong>AXRichSnackbar</strong> (Inverse variant) above
        ...
        <div className={styles.section}>
          ...
          <pre className={styles.codeBlock}>{`import { AXQueueBanner } from '@/components/walmart/AXQueueBanner';
          ...
          <div className={styles.guidelineGrid}>
            <div className={styles.guidelineCard}>
              ...
              <p className={styles.guidelineText}>
                ...
                pair it with a AXRichSnackbar (Inverse) above it.
              </p>
            </div>
            <div className={styles.guidelineCard}>
