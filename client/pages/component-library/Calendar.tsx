    ...
    <div style={{ padding: '48px', maxWidth: '1400px', margin: '0 auto' }}>
      <div style={{ marginBottom: '32px' }}>
        ...
        <p style={{ fontSize: '16px', lineHeight: '1.6', color: 'var(--ld-semantic-color-text-secondary, #74767C)', maxWidth: '800px' }}>
          LD 3.5 date selection calendar component with support for standard week view (Sun-Sat) and week numbers variant (Sat-Fri). Supports single, multiple, and range selection modes.
        </p>
      </div>
