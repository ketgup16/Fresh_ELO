...
function TwoImagesDemo() {
  ...
  return <AXUploadImage images={images} onChange={setImages} />;
}
...
export default function AXUploadImagePage() {
  return (
    <ComponentPageLayout
      ...
      <div className={exStyles.pageGap}>
        ...
        <section className={exStyles.section}>
          ...
          <div className={styles.grid}>
            ...
            >
              <AXUploadImage images={[]} onChange={() => {}} invalid />
            </DemoCard>
