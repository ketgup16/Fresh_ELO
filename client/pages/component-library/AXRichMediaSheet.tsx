...
import {
  AXRichMediaSheet,
  AXRichMediaSheetHeaderVariant,
  AXRichMediaSheetSurfaceVariant,
...
const HEADER_VARIANTS: { label: string; value: AXRichMediaSheetHeaderVariant; desc: string }[] = [
...
const SURFACE_VARIANTS: { label: string; value: AXRichMediaSheetSurfaceVariant; desc: string }[] = [
...
export default function AXRichMediaSheetPage() {
  const [openDemo, setOpenDemo] = useState<string | null>(null);
  const [activeHeader, setActiveHeader] = useState<AXRichMediaSheetHeaderVariant>('title');
  const [activeSurface, setActiveSurface] = useState<AXRichMediaSheetSurfaceVariant>('default');
