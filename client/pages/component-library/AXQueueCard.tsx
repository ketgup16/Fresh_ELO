...
import styles from './AXQueueCard.module.css';
...
export default function AXQueueCardPage() {
    ...
    >
      <div className={styles.page}>
        ...
        <div className={styles.section}>
          ...
          <pre className={styles.codeBlock}>{`import { AXQueueCard } from '@/components/walmart/AXQueueCard';
