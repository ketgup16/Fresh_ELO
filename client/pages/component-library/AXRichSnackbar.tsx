...
import { AXRichSnackbar } from '@/components/walmart/AXRichSnackbar';
import type {
  AXRichSnackbarColor,
  AXRichSnackbarContentVariant,
} from '@/components/walmart/AXRichSnackbar';
import { wcpRichSnackbar, dismissAXRichSnackbar } from '@/hooks/use-ax-rich-snackbar';
import { Button } from '@/components/ui/Button';
import { Cart } from '@/components/icons/Cart';
import { Gift } from '@/components/icons/Gift';
import { CheckCircle } from '@/components/icons/CheckCircle';
import { InfoCircle } from '@/components/icons/InfoCircle';
import styles from './AXRichSnackbar.module.css';

// ── Static snackbar preview (not fixed-position) ─────────────────────────

function StaticSnackbar(props: React.ComponentProps<typeof AXRichSnackbar>) {
  return (
    <div className={styles.previewWrap}>
      <AXRichSnackbar {...props} open inline duration={Infinity} />
    </div>
  );
}
...
const COLOR_VARIANTS: { color: AXRichSnackbarColor; label: string; dark?: boolean }[] = [
...
const CONTENT_VARIANTS: { variant: AXRichSnackbarContentVariant; label: string }[] = [
...
const IconLeading = ({ color }: { color: AXRichSnackbarColor }) => {
...
export default function AXRichSnackbarPage() {
  const [liveColor, setLiveColor] = useState<AXRichSnackbarColor>('primary');
  const [liveVariant, setLiveVariant] = useState<AXRichSnackbarContentVariant>('left-regular');
    ...
    >
      <div className={styles.page}>
        ...
        <div className={styles.section}>
          ...
          <SectionDesc>
            The AX Rich Snackbar builds on the LD Snackbar with a leading media slot and visual
        ...
        <div className={styles.section}>
          ...
          <SectionDesc>
            Four color variants cover the full range of AX surface contexts.
          </SectionDesc>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.triggerRow}>
            ...
            <Button variant="secondary" size="medium" onClick={dismissAXRichSnackbar}>
              Dismiss
            </Button>
          </div>
        </div>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.guidelineGrid}>
            ...
            <div className={styles.guidelineCard}>
              ...
              <p className={styles.guidelineText}>
                Don't use the AX Rich Snackbar if your message is purely informational. Instead
        ...
        <div className={styles.section}>
          ...
          <SectionDesc>
            ...
            <code>AXRichSnackbarContainer</code> is already mounted in <code>App.tsx</code> and
            will render it automatically.
          </SectionDesc>
          <pre className={styles.codeBlock}>{`import { wcpRichSnackbar } from '@/hooks/use-ax-rich-snackbar';
import { Cart } from '@/components/icons/Cart';
...
wcpRichSnackbar({
  ...
  position: 'bottom-center', // 'bottom-left' | 'bottom-center' | 'bottom-right'
          ...
          <SectionDesc>
            You can also use the <code>useAXRichSnackbar</code> hook for component-level control:
          </SectionDesc>
          <pre className={styles.codeBlock}>{`import { useAXRichSnackbar } from '@/hooks/use-ax-rich-snackbar';

function MyComponent() {
  const { show, dismiss } = useAXRichSnackbar();
