            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-lg border border-[#E3E4E5] p-6">
                ...
                <div className="flex items-center gap-8 mb-6">
                  ...
                  <div className="relative w-32 h-32">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="text-3xl font-bold text-[#2E2F32]">48%</span>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <h3 className="text-sm font-bold text-[#2E2F32] mb-3">Listing score breakdown</h3>
                  
                  <div className="flex items-center justify-between py-2 border-b border-[#E3E4E5]">
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-[#2E2F32]">Category</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <span className="text-sm text-[#2E2F32] w-16 text-right">Score</span>
                      <span className="text-sm text-[#2E2F32] w-20 text-right">Performance</span>
                    </div>
                  </div>

                  <div className="flex items-center justify-between py-2">
                    <span className="text-sm text-[#2E2F32]">Price competitiveness</span>
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-2 w-16 justify-end">
                        <span className="text-sm text-[#2E2F32]">N/A</span>
                      </div>
                      <span className="text-sm text-[#C41E2E] w-20 text-right">Poor</span>
                    </div>
                  </div>

                  <div className="flex items-center justify-between py-2">
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-[#2E2F32]">Shipping</span>
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M8 15C11.866 15 15 11.866 15 8C15 4.13401 11.866 1 8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15ZM8 14C4.68629 14 2 11.3137 2 8C2 4.68629 4.68629 2 8 2C11.3137 2 14 4.68629 14 8C14 11.3137 11.3137 14 8 14Z" fill="#515357"/>
                        <path d="M7.40039 7H8.60039V11.5H7.40039V7Z" fill="#515357"/>
                        <path d="M7.99961 6.3C8.49667 6.3 8.89961 5.89706 8.89961 5.4C8.89961 4.90294 8.49667 4.5 7.99961 4.5C7.50255 4.5 7.09961 4.90294 7.09961 5.4C7.09961 5.89706 7.50255 6.3 7.99961 6.3Z" fill="#515357"/>
                    ...
                    <div className="flex items-center gap-4">
                      <span className="text-sm text-[#2E2F32] w-16 text-right">39.86%</span>
                      <span className="text-sm text-[#C41E2E] w-20 text-right">Poor</span>
                    </div>
                  </div>

                  <div className="flex items-center justify-between py-2">
                    <span className="text-sm text-[#2E2F32]">Published and in stock</span>
                    <div className="flex items-center gap-4">
                      <span className="text-sm text-[#2E2F32] w-16 text-right">42.52%</span>
                      <span className="text-sm text-[#C41E2E] w-20 text-right">Poor</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between py-2">
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-[#2E2F32]">Ratings & Reviews</span>
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M8 15C11.866 15 15 11.866 15 8C15 4.13401 11.866 1 8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15ZM8 14C4.68629 14 2 11.3137 2 8C2 4.68629 4.68629 2 8 2C11.3137 2 14 4.68629 14 8C14 11.3137 11.3137 14 8 14Z" fill="#515357"/>
                        <path d="M7.40039 7H8.60039V11.5H7.40039V7Z" fill="#515357"/>
                        <path d="M7.99961 6.3C8.49667 6.3 8.89961 5.89706 8.89961 5.4C8.89961 4.90294 8.49667 4.5 7.99961 4.5C7.50255 4.5 7.09961 4.90294 7.09961 5.4C7.09961 5.89706 7.50255 6.3 7.99961 6.3Z" fill="#515357"/>
                    ...
                    <div className="flex items-center gap-4">
                      <span className="text-sm text-[#2E2F32] w-16 text-right">47.1%</span>
                      <span className="text-sm text-[#C41E2E] w-20 text-right">Poor</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between py-2">
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-[#2E2F32]">Content quality</span>
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M8 15C11.866 15 15 11.866 15 8C15 4.13401 11.866 1 8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15ZM8 14C4.68629 14 2 11.3137 2 8C2 4.68629 4.68629 2 8 2C11.3137 2 14 4.68629 14 8C14 11.3137 11.3137 14 8 14Z" fill="#515357"/>
                        <path d="M7.40039 7H8.60039V11.5H7.40039V7Z" fill="#515357"/>
                        <path d="M7.99961 6.3C8.49667 6.3 8.89961 5.89706 8.89961 5.4C8.89961 4.90294 8.49667 4.5 7.99961 4.5C7.50255 4.5 7.09961 4.90294 7.09961 5.4C7.09961 5.89706 7.50255 6.3 7.99961 6.3Z" fill="#515357"/>
                    ...
                    <div className="flex items-center gap-4">
                      <span className="text-sm text-[#2E2F32] w-16 text-right">80.07%</span>
              ...
              <div className="bg-white rounded-lg border border-[#E3E4E5] p-6">
                ...
                <p className="text-sm text-[#2E2F32] mb-6">See how your items are ranked and unlock growth opportunities.</p>

                <div className="grid grid-cols-4 gap-4">
                  {/* Typical Card */}
                  <div className="bg-white border border-[#E3E4E5] rounded p-4">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-sm text-[#74767C]">Typical</span>
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    ...
                    <div className="text-3xl font-bold text-[#2E2F32] mb-1">49</div>
                    <div className="text-xs text-[#74767C]">$2,00.00</div>
                    <div className="text-xs text-[#74767C]">Last 30-day GMV</div>
                  </div>

                  {/* Poor Card */}
                  <div className="bg-white border border-[#E3E4E5] rounded p-4">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-sm text-[#74767C]">Poor</span>
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M8 15C11.866 15 15 11.866 15 8C15 4.13401 11.866 1 8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15ZM8 14C4.68629 14 2 11.3137 2 8C2 4.68629 4.68629 2 8 2C11.3137 2 14 4.68629 14 8C14 11.3137 11.3137 14 8 14Z" fill="#74767C"/>
                        <path d="M7.40039 7H8.60039V11.5H7.40039V7Z" fill="#74767C"/>
                        <path d="M7.99961 6.3C8.49667 6.3 8.89961 5.89706 8.89961 5.4C8.89961 4.90294 8.49667 4.5 7.99961 4.5C7.50255 4.5 7.09961 4.90294 7.09961 5.4C7.09961 5.89706 7.50255 6.3 7.99961 6.3Z" fill="#74767C"/>
                    ...
                    <div className="text-3xl font-bold text-[#2E2F32] mb-1">33</div>
                    <div className="text-xs text-[#74767C]">$1,393.00</div>
                    <div className="text-xs text-[#74767C]">Last 30-day GMV</div>
                  </div>
                  ...
                  <div className="bg-white border border-[#E3E4E5] rounded p-4">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-sm text-[#74767C]">Good</span>
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M8 15C11.866 15 15 11.866 15 8C15 4.13401 11.866 1 8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15ZM8 14C4.68629 14 2 11.3137 2 8C2 4.68629 4.68629 2 8 2C11.3137 2 14 4.68629 14 8C14 11.3137 11.3137 14 8 14Z" fill="#74767C"/>
                        <path d="M7.40039 7H8.60039V11.5H7.40039V7Z" fill="#74767C"/>
                        <path d="M7.99961 6.3C8.49667 6.3 8.89961 5.89706 8.89961 5.4C8.89961 4.90294 8.49667 4.5 7.99961 4.5C7.50255 4.5 7.09961 4.90294 7.09961 5.4C7.09961 5.89706 7.50255 6.3 7.99961 6.3Z" fill="#74767C"/>
                    ...
                    <div className="text-3xl font-bold text-[#2E2F32] mb-1">15</div>
                    <div className="text-xs text-[#74767C]">$11,152.00</div>
                    <div className="text-xs text-[#74767C]">Last 30-day GMV</div>
                  </div>
                  ...
                  <div className="bg-white border border-[#E3E4E5] rounded p-4">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-sm text-[#74767C]">Excellent</span>
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M8 15C11.866 15 15 11.866 15 8C15 4.13401 11.866 1 8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15ZM8 14C4.68629 14 2 11.3137 2 8C2 4.68629 4.68629 2 8 2C11.3137 2 14 4.68629 14 8C14 11.3137 11.3137 14 8 14Z" fill="#74767C"/>
                        <path d="M7.40039 7H8.60039V11.5H7.40039V7Z" fill="#74767C"/>
                        <path d="M7.99961 6.3C8.49667 6.3 8.89961 5.89706 8.89961 5.4C8.89961 4.90294 8.49667 4.5 7.99961 4.5C7.50255 4.5 7.09961 4.90294 7.09961 5.4C7.09961 5.89706 7.50255 6.3 7.99961 6.3Z" fill="#74767C"/>
                    ...
                    <div className="text-3xl font-bold text-[#2E2F32] mb-1">3</div>
                    <div className="text-xs text-[#74767C]">$11,352.00</div>
                    <div className="text-xs text-[#74767C]">Last 30-day GMV</div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 flex-wrap">
                  <div className="flex items-center gap-2 flex-1">
                    <span className="text-sm text-[#2E2F32]">Search by</span>
                    <select className="h-10 px-3 border border-[#BABBBE] rounded text-sm text-[#2E2F32] bg-white">
                      <option>Title</option>
                      <option>SKU</option>
                    </select>
                    <input
                  ...
                  <div className="flex items-center gap-2">
                    <button className="h-10 px-4 bg-white border border-[#BABBBE] rounded text-sm text-[#2E2F32] flex items-center gap-2 hover:bg-gray-50">
                      Customer Favorites
                ...
                {/* Table */}
                <div className="border border-[#E3E4E5] rounded overflow-hidden">
                  <table className="w-full">
                    <thead className="bg-[#F7F8F9] border-b border-[#E3E4E5]">
                      <tr>
                        <th className="px-4 py-3 text-left text-sm font-bold text-[#2E2F32]">Item name</th>
                        <th className="px-4 py-3 text-left text-sm font-bold text-[#2E2F32]">SKU</th>
                        <th className="px-4 py-3 text-left text-sm font-bold text-[#2E2F32]">Condition</th>
                        <th className="px-4 py-3 text-left text-sm font-bold text-[#2E2F32]">Priority</th>
                        <th className="px-4 py-3 text-left text-sm font-bold text-[#2E2F32]">Listing quality ⓘ</th>
                        <th className="px-4 py-3 text-left text-sm font-bold text-[#2E2F32]">Page views ⓘ</th>
                        <th className="px-4 py-3 text-left text-sm font-bold text-[#2E2F32]">GMV ⓘ</th>
                        <th className="px-4 py-3 text-left text-sm font-bold text-[#2E2F32]">Action</th>
                      </tr>
                    </thead>
                    <tbody>
                      {items.map((item, idx) => (
                        <tr key={idx} className="border-b border-[#E3E4E5] hover:bg-gray-50">
                          <td className="px-4 py-3 text-sm text-[#2E2F32]">{item.name}</td>
                          <td className="px-4 py-3 text-sm text-[#2E2F32]">{item.sku}</td>
                          <td className="px-4 py-3 text-sm text-[#2E2F32]">{item.condition}</td>
                          <td className="px-4 py-3 text-sm text-[#2E2F32]">{item.priority}</td>
                          <td className="px-4 py-3">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm text-[#2E2F32]">{item.listingQuality}%</span>
                            </div>
                          </td>
