...
import { ChevronDown, ChevronUp, Search, Bell, HelpCircle, User } from "lucide-react";
...
export default function DisplayAdvertisingCampaigns() {
  ...
  const handleMenuItemClick = (itemId: string) => {
    ...
    if (itemId === 'dashboard') {
      navigate('/');
    } else if (itemId === 'campaigns' || itemId.startsWith('campaigns-')) {
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <header className="h-[54px] border-b border-[#E3E4E5] flex items-center justify-between px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="p-2 hover:bg-gray-100 rounded-full transition-colors">
            <Bell className="w-4 h-4 text-[#2E2F32]" />
          </button>
          ...
          <button className="p-2 hover:bg-gray-100 rounded-full transition-colors">
            <User className="w-4 h-4 text-[#2E2F32]" />
          </button>
        </div>
      </header>
      ...
      <div className="flex h-[calc(100vh-54px)]">
        ...
        {/* Main Content */}
        <main className="flex-1 h-auto self-stretch flex flex-col overflow-y-auto bg-[#F8F8F8]">
          <div className="px-6 pt-8 pb-4">
            <div className="flex items-center justify-between mb-4">
              <h1 className="text-2xl font-bold text-[#2E2F32]">Display Advertising - Campaigns</h1>
            ...
            <div className="border-b border-[#E3E4E5]">
              <div className="flex gap-0">
                <button
                  className="px-0 py-3 text-sm relative font-bold text-[#2E2F32] after:absolute after:bottom-0 after:left-0 after:right-0 after:h-[3px] after:bg-[#0053E2] after:rounded-t"
                >
                  All campaigns
                </button>
                <button
                  className="ml-6 px-0 py-3 text-sm relative font-normal text-[#2E2F32] hover:bg-gray-50"
                >
                  Active
                </button>
                <button
          ...
          <div className="px-6 py-6">
            <div className="bg-white rounded-lg border border-[#E3E4E5] p-8 text-center">
              <h2 className="text-xl font-bold text-[#2E2F32] mb-2">Campaigns</h2>
              <p className="text-[#515357]">Campaign management interface will be here</p>
            </div>
          </div>
        </main>
      </div>
      ...
      {showMartyPanel && (
        <MartyFloatingPanel isMinimized={isMartyMinimized} onToggleMinimize={() => setIsMartyMinimized(!isMartyMinimized)} />
      )}
    </div>
  );
}
