...
import { ChevronRight, ChevronDown, ChevronUp, Search, Settings, Download, Bell, HelpCircle, User, MoreHorizontal, Eye, Sliders, X } from "@/components/icons";
...
const archivedCampaigns: Campaign[] = [
  ...
  },
  {
    ...
    pacing: { value: "108%", color: "text-[#995213]" },
    expanded: false,
    children: []
  },
  {
              ...
              <div className="flex items-center gap-2 relative">
                ...
                <div className="relative">
                  <button
                    ...
                    aria-label={livePacingFilter.length > 0
                      ? `Filter by pacing status. ${livePacingFilter.length} filter${livePacingFilter.length !== 1 ? 's' : ''} applied`
