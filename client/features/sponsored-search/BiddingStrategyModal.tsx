        ...
        <div className="px-6 pt-6 pb-0">
          <div className="flex flex-col gap-1">
            <div className="flex items-center justify-between">
              <ModalTitle className="text-[20px] font-bold text-[#2E2F32] leading-7">
                Bidding strategy
              </ModalTitle>
              <ModalClose className="rounded-sm opacity-70 hover:opacity-100 transition-opacity absolute right-6 top-6 w-auto h-auto">
                <X className="h-4 w-4" />
                <span className="sr-only">Close</span>
              </ModalClose>
            </div>
            <ModalDescription className="text-sm text-[#2E2F32] leading-5">
