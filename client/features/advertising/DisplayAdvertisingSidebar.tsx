      ...
      <div style={{
        ...
        <button
          ...
          className={`flex items-center justify-center ${
            sidebarExpanded ? 'gap-3 px-3 w-full' : 'w-10'
